...
- [ ] 1.1 Create (or reuse) a Google Cloud service account for CI deploys and grant it `Firebase Hosting Admin`, `Firebase Rules Admin`, `Service Usage Admin`, and `Firebase Storage Admin` roles on the Firebase project; verify the roles appear on the service account in the IAM console
